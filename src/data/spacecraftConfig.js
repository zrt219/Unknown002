...
export const cameraPresets = {
  ...
  payloadClose: {
    label: 'Payload Close',
    category: 'Subsystem Close-Ups',
    position: [18.7, 6.4, 8.8],
    target: [15.2, 3.35, -2.2],
    fov: 22,
    lockPan: true,
    showGrid: false,
    recommendedLabelProfile: 'reduced-review',
